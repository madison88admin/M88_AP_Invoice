...
router.get('/scheduled-payments', authorize(UserRole.ACCOUNTING_SUPERVISOR, UserRole.CFO, UserRole.IT_ADMIN), paymentBatchController.getScheduledPaymentsForBatchController);
router.get('/', authorize(UserRole.ACCOUNTING_SUPERVISOR, UserRole.CFO, UserRole.IT_ADMIN), paymentBatchController.getPaymentBatchesController);
router.get('/:batchId', authorize(UserRole.ACCOUNTING_SUPERVISOR, UserRole.CFO, UserRole.IT_ADMIN), paymentBatchController.getPaymentBatchByIdController);
