...
- due_date: Due date / payment due date (format: YYYY-MM-DD)
- payment_terms: Payment terms text (e.g., "30 Days", "Net 30", "DUE DATE")
...
- ship_to: Ship to company/address
- sold_to: Sold to company/address
