...
const STATUS_CONFIG: Record<POValidationStatus, { color: string; icon: React.ReactNode; label: string; bg: string; text: string; border: string }> = {
  ...
  WARNING:   { color: 'yellow', icon: <AlertTriangle className="h-3.5 w-3.5" strokeWidth={2} />, label: 'Variance Warning',    bg: 'bg-amber-500/20',  text: 'text-amber-400',  border: 'border-amber-400/30' },
