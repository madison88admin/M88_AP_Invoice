...
const navItems: NavItem[] = [
  ...
  { label: 'Bank Details', path: '/bank-details', icon: Landmark, roles: ['PURCHASING_COORDINATOR', 'PURCHASING_MANAGER', 'ACCOUNTING_SUPERVISOR', 'ACCOUNTING_ASSOCIATE', 'IT_ADMIN'] },
